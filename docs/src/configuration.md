...
| `CREDENTIAL_CONFIGURATION_ID` | The credential configuration ID to use for credential offers. This must match the identifier of a credential configuration created through the SSI agent CLI tool. |
