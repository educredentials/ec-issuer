...
class CredentialChecks:
    """Verification checks from cli-vc-wallet."""

    jwt_format_valid: bool | None = None
    header_decoded: bool | None = None
    payload_decoded: bool | None = None
    signature_present: bool | None = None
    has_verifiable_credential: bool | None = None
    has_issuer: bool | None = None
