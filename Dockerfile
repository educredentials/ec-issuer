...
# Development: Flask dev server with hot-reload support via volume mounts
FROM gcr.io/distroless/base-debian12 AS web-dev
...
COPY --chown=65532:65532 templates/01_openbadge_credential_template.json /etc/templates/openbadge_credential_template.json
COPY --chown=65532:65532 templates/02_european_credential_template.json /etc/templates/european_credential_template.json
